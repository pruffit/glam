    ...
    <div className="min-h-screen bg-pink-500 text-white overflow-hidden">
      ...
      >
        <div className="max-w-2xl md:p-8 p-2">
          ...
          <p className="mb-4 md:text-lg text-base">
            Привет! Ты успешно справился(ась) с первыми трудностями и уже прошел(ла) дальше, чем мы ожидали. Уверен, что поиск кода/пароля был не самым простым делом, но это только начало нашего увлекательного пути.
          </p>
          <p className="mb-4 md:text-lg text-base">
